...
# When downloading... make sure to name your anime files in this format:   "anime-[AnimeName]-[SeasonNumber]-[EpisodeNumber].mp4"
# example:   anime-AttackOnTitan-1-3  (No spaces, and keep the folder names consistant!)
# REPLACE ALL PATHS WITH YOUR OWN PATH BEFORE RUNNING!
...
while True:
    ...
    for file in good_anime_list:
        ...
        if not os.path.exists("C:/Users/korisnik/Downloads/Anime/" + str(filename_arr[1]) + "/Season " + str(filename_arr[2])):
